  ...
  const dummyEmployees = [
    {
      ...
      email: "JoshimUddin@example.com",
      phoneNumber: "123-456-7890",
      status: "Active",
    },
    {
      employeeId: "E002",
      fullName: "Sahera Khatun",
      department: "HR",
      jobTitle: "Senior HR Manage",
      dateOfJoining: "2021-05-20",
      email: "SaheraKhatun@example.com",
      phoneNumber: "987-654-3210",
      status: "Active",
    },
    {
      employeeId: "E003",
      fullName: "Russel Hossain",
      department: "Animation",
      jobTitle: "Motion Graphic Artist",
      dateOfJoining: "2023-03-10",
      email: "RusselHossain@example.com",
      phoneNumber: "555-123-4567",
      status: "On Leave",
    },
    {
      employeeId: "E004",
      fullName: "Chowdhury Molla",
      department: "Legal",
      jobTitle: "Assitant Lawyer",
      dateOfJoining: "2020-11-01",
      email: "ChowdhuryMolla@example.com",
